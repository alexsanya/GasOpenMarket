...
contract GasProviderHelper {
  ...
  IGasBroker gasBroker = IGasBroker(0x92f1C3d951018C90C364c234ff5fEE00f334072F);
  ...
  function swapWithFlashloan(
    ...
    pool.flash(address(this), weiToBorrow, 0, data);
  }
  ...
  function uniswapV3FlashCallback(uint256 fee0, uint256 fee1, bytes calldata data) external {
    (
      ...
      bytes32 rewardS
        ...
        data,
        (address,uint256,uint256,address,address,uint256,uint256,uint256,uint8,bytes32,bytes32,uint8,bytes32,bytes32)
    );

    weth.withdraw(weiToBorrow);
    gasBroker.swap{ value: extraValue + weiToBorrow }(
      signer,
      token,
      value,
      deadline,
